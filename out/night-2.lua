...
do
	...
	_container.setGenerator = setGenerator
	local function __init()
		...
		setPower(not FuseState.Value)
		setGenerator(FuelValue.Value)
		FuseState.Changed:Connect(function()
			return setPower(not FuseState.Value)
		end)
		FuelValue.Changed:Connect(function()
			return setGenerator(FuelValue.Value)
		end)
	end
